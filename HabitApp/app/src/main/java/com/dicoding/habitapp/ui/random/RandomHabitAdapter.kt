...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        private val startTime: TextView = itemView.findViewById(R.id.pager_startTime)
        private val priorityLevel: ImageView = itemView.findViewById(R.id.priority_level)
        private val minutes: TextView = itemView.findViewById(R.id.pager_minutes)
        private val countDownBtn: TextView = itemView.findViewById(R.id.btn_countDown)
        ...
        fun bind(pageType: PageType, pageData: Habit) {
            ...
            priorityLevel.setImageResource(priorityColor)

            minutes.text = pageData.minutesFocus.toString()

            countDownBtn.setOnClickListener { onClick(pageData) }
        }
    }
}
